...
public class TestConfig{
	...
	public static String from = "mytraining1311@gmail.com";
	public static String password = "LearningTesting";
	public static String[] to ={"mytraining1311@gmail.com","mytraining1311@gmail.com"};
